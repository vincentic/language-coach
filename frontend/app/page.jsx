  ...
  const playAudio = async () => {
    ...
    try {
      ...
      utterance.onend = () => {
        ...
        if (listenCount >= 2) {
          setStepProgress(prev => ({ ...prev, listen: true }))
        }
      }
    } catch (err) {
        ...
        <>
          ...
          <div className="steps-grid">
            ...
            <div className={`step-card ${stepProgress.shadow ? 'completed' : ''}`}>
              ...
              <div className="step-body">
                ...
                <button className="record-btn" disabled>
                  🎤 Hold to Record
                </button>
            ...
            <div className={`step-card ${stepProgress.apply ? 'completed' : ''}`}>
              ...
              <div className="step-body">
                ...
                <textarea
                  ...
                  placeholder="Write your own sentence using similar patterns..."
                  rows={3}
                />
          ...
          {allCompleted && (
            <div className="completion-banner">
              ...
              <button onClick={initializeSession} className="next-btn">
                Start New Session →
              </button>
            </div>
          )}
